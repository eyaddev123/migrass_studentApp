  ...
  Future<bool?> _confirmDelete(BuildContext context, int index) {
    return showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          defauilButton( background: ColorManager.lightGray, textcolorbutton: ColorManager.black, function: () => Navigator.pop(ctx, false), text: "لا", ),
          defauilButton( background:ColorManager.lightGray, textcolorbutton: ColorManager.black, function: () => Navigator.pop(ctx, true), text: "نعم", ),
        ],
      ),
    );
  }
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      FloatingActionButton(
                        ...
                        child: const Icon(Icons.send, size: 28, color: ColorManager.white),
                      ),
                    ],
                  ),
                FloatingActionButton(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Container(
                              ...
                              child: Row(
                                children: [
                                  GestureDetector(
                                    onTap: () => bloc.add(PlayRecording(rec.filePath)),
                                    child: Container(
                                      width: 36,
                                      height: 36,
                                      decoration: BoxDecoration(
                                      ...
                                      child: Center(
                                        child: Container(
                                          ...
                                          child: Center(
                                            child: Icon(
                                              state.isPlaying && state.currentPlayingPath == rec.filePath
                                                  ? Icons.pause
                                                  : Icons.play_arrow,
                                              size: 18,
                            ...
                            return Container(
                              ...
                              child: Row(
                                children: [
                                  GestureDetector(
                                    onTap: () =>
                                        bloc.add(PlayRecording(rec.filePath)),
                                    child: Container(
                                      width: 36,
                                      height: 36,
                                      decoration: BoxDecoration(
